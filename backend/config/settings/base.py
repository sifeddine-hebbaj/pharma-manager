"""
Base settings for PharmaManager project.
...
SPECTACULAR_SETTINGS = {
    ...
    'TAGS': [
        ...
        {'name': 'medicaments', 'description': 'Gestion du catalogue de médicaments'},
        {'name': 'ventes', 'description': 'Gestion des ventes et transactions'},
    ],
}
